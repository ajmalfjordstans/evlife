    ...
    <div className="w-full container mx-auto">
      <div className="flex flex-col items-center mt-[50px]">
        ...
        <div className="grid grid-cols-3 mt-20 gap-10">
          <div>
            <Typography placeholder='' variant="h5" color="blue-gray" className="mb-7 text-center">
              POWERPOD HOME
            </Typography>
            <Typography placeholder='' variant="paragraph" color="blue-gray" className="mb-2 text-center">
