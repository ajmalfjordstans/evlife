    ...
    <div className='bg-[#7348a1b7]'>
      <div className='w-[100%] max-w-[1440px] mx-auto px-[6%] text-white py-[80px]' id='contact'>
        ...
        <div className='flex flex-col items-center'>
          <p className='text-[16px] font-[700] leading-[24px] mt-[20px]'>
            Email:
            <a className='hover:cursor-pointer' href="mailto:info@evlife.co.in">info@evlife.co.in</a>
          </p>
          <p className='mt-[10px] text-[16px] font-[700] leading-[24px]'>
            Phone:
            <a className='hover:cursor-pointer' href="tel:+917736677477">+91 77366 77477</a>
          </p>
          <button
